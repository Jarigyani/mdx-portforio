...
! ACL設定
access-list 10 deny host 10.20.0.0 0.0.255.255
access-list 10 deny host 10.30.0.0 0.0.255.255
access-list 10 permit any

access-list 20 deny host 10.10.0.0 0.0.255.255
access-list 20 deny host 10.30.0.0 0.0.255.255
access-list 20 deny host 10.50.0.0 0.0.255.255
access-list 20 permit any

access-list 30 deny host 10.10.0.0 0.0.255.255
access-list 30 deny host 10.20.0.0 0.0.255.255
access-list 30 deny host 10.50.0.0 0.0.255.255
